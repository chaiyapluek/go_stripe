...
func (app *application) serve() error {
	...
	app.infoLog.Printf("Starting HTTP server %s mode on port %d", app.config.env, app.config.port)
...
func main() {
	...
	flag.IntVar(&cfg.port, "port", 4000, "Server port to listen port")
	...
	flag.StringVar(&cfg.secretKey, "secretkey", "RSdhuQeSYCVle7rI7zgVlcY9lMUsC07X", "secret key")
	...
	infoLog.Println(os.Getenv("STRIPE_KEY"))
	infoLog.Println(os.Getenv("STRIPE_SECRET"))
